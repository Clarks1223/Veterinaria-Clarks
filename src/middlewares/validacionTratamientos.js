...
export const validacionTratamiento = [
  check(["nombre", "descripcion", "prioridad", "paciente"])
    .exists()
    .withMessage(
      'Los campos "nombre" "descripcion" "prioridad" y/o "paciente" son obligatorios'
    )
    .notEmpty()
    .withMessage(
      'Los campos "nombre" "descripcion" "prioridad" y/o "paciente" no pueden estar vacíos'
    )
  ...
  check("paciente").isMongoId().withMessage("El ID del paciente no es válido"),
